...
public class LevelController {
    ...
    static String[][] levels_normal = {
            { "S4", "R31", "+-", "HD2_4_5_7_10_12_13_15", "HB0", "АПорядок действий:\n1) Клик на знаке выбирает нужное действие.\n2) Клик на числе совершает это действие с выбранным числом.\n\nЦель: превратить 0 в 31" },
            { "S4", "R41", "+-", "HD2_4_5_7_10_12_13_15", "HB0", "АНу, раз уж ты справился с тем нелегким испытанием, вот тебе еще одно" },
            { "S4", "R59", "+-", "HS5", "HD2_4_6_8_10_12_14_16_18_20_22_24" },
            { "S4", "R92", "+-", "StackSet*", "HD2_4_5_7_10_12_13_15", "HB0", "АВам доступен знак умножения снизу основных знаков (используется только один раз)" },
            { "S4", "R6",  "+-", "StackSet/", "C92", "HD2_4_5_7_10_12_13_15", "HB0", "АИногда необходимо идти в обратную сторону" },
            { "S4", "R1000", "+-*", "Overflow", "C6", "АНа этом уровне можно и преувеличить, не набирая ровно 1000" },
            { "S4", "R6000", "+-*", "Overflow", "C10", "HB35" },

            // 2
            { "S5", "K1", "R535", "+-*", "HD2_4_6_8_10_12_14_16_18_20_22_24", "АНововведение! Теперь двойной клик на знаке сохраняет его" },
            { "S5", "K1", "R897", "+-*", "HD2_4_6_8_10_12_14_16_18_20_22_24" },
            { "S5", "K1", "R932", "+-*", "HD2_4_6_8_10_12_14_16_18_20_22_24" },
            { "S4", "K1", "R38", "C932", "+-*", "HD2_4_5_7_10_12_13_15", "HB0", "StackSet/" },
            { "S5", "K2", "R4626", "HK0", "C38", "+-*" },
            { "S5", "K2", "R10000", "HR50000", "+-*", "Overflow" },
            { "S5", "K2", "R100000", "HR7000000", "+-*", "Overflow", "StackSet*", "HА вот тут бы не помешало немного удачи" },

            // Gemini 3
            { "S4", "K3", "R200", "HR100_200_300_400", "HK0", "C-1", "G+", "StackSetG", "АПоявился специальный знак, дублирующий число, на которое нажали" },
            { "S4", "K3", "R-121_1331", "HR-200_4000", "C-2", "PG_11_*_15_+_37_-_37", "StackSetG", "StackSetG", "StackSetG", "HD2_4_6_8_10_12_14_16_18_20_22_24", "HB0" },
            { "S5", "K3", "R2056", "HR400000", "C-3", "G+*", "АВнимание! После прохождения данного уровня все данные телефона будут удалены! (в том числе и эта игра)" },
            { "S5", "K3", "R-4", "C500", "G+-", "HD2_4_6_8_10_12_14_16_18_20_22_24", "HB0" },
            { "S5", "K3", "R500", "C-5", "G+-*/", "HD2_4_6_8_10_12_14_16_18_20_22_24", "HB0" },
            { "S5", "K3", "R-6", "C800", "G+-*/", "HR-6_600", "HD2_4_6_8_10_12_14_16_18_20_22_24", "HB0" },
            ...
            { "S4", "K3", "R9000", "HK0", "HR30000", "L+10*_-3*", "StackSet*", "StackSetG",  "Overflow" },
            ...
            { "S5", "K2", "P*_60_/_40", "C1", "R1000000", "HR700000000", "HK0", "Overflow" },

            // Prince (Cancer 6)
            { "S4", "K2", "R8_80", "HR20_200", "+-C", "HStackSetG", "АНовый знак меняет местами текущее число и нажатое" },
            { "S5", "K2", "R-15_150", "HR150_-175_200", "+-C", "HStackSetG", "HStackSetG" },
            { "S4", "K2", "R1000", "HR4000", "+-", "StackSetC", "HStackSetG", "StackSet*" },
            { "S4", "K2", "R3599", "L+_+2*", "HP+_20_+2*_80", "StackSetC", "StackSet*", "HD2_4_5_7_10_12_13_15", "HB0" },
            { "S4", "K2", "R1110", "HR2222", "+*C" },
            { "S3", "K2", "R10000", "HR60000", "C1", "P*_50_C_50", "StackSet+", "StackSet+", "StackSet+", "StackSet+", "StackSet+" },
            { "S6", "K0", "R1048576", "HR16777216", "L+_+2*_+10*", "StackSetC", "StackSetC", "StackSetG", "StackSetG", "HStackSetG", "Overflow" },
            ...
            { "Sorcerer3", "S5", "R100", "HR3333", "L-_-3*", "StackSetG", "StackSetC", "StackSet*" },
            { "Sorcerer1", "S6", "R1000", "HR3600", "K3", "Overflow", "+*C" },

            // Revolutionary (Pow 9)
            { "S5", "K0", "R618", "C1", "L+2*_-", "StackSetP", "АСвершилось! Теперь вы можете не только умножать и делить, но и возводить в степень! Правда, эффект действует только на нажатое число." },
            ...
            { "Repeat1", "S3", "R27", "+C", "HS4", "HR9_8", "H+*C", "NStackSet*", "NStackSet*" },
            { "Repeat4", "S5", "C1", "R2_3_4_5", "HR2_3_4_5_6_7_8", "K3", "+-*/" },
            { "Repeat2", "S6", "C10", "R10_10_10_10_10_10", "N+/", "H-GC" },
            { "Repeat1", "S5", "R2_7_1_8_2_8_1_8_2", "K3", "HS6", "HK5", "HR2_7_1_8_2_8_1_8_2_8_4_5_9_0_4_5", "+C", "StackSetG", "StackSetC", "StackSet*" },
            { "Repeat9", "S6", "R9999", "HR9999999", "K5", "P+_64_G_18_C_18" },

            // King (Special 10)
            { "S5", "K1", "*-", "C20", "R-2_-30_-400_-5000", "HR-30_-5000_-700000", "АПоздравляем тебя, игрок, дошедший до таких немыслимых пределов. Остались последние, наисложнейшие, коварнейшие испытания. Попробуй пройти и их!" },
            { "S4", "K2", "P*_60_/_40", "C1", "R21_31_41_51", "HC61", "HR51_41_31_21", "HStackSetG", "HStackSetG", "HStackSetG" },
            { "S3",       "*/", "C12", "R11", "HR11_10_9", "HStackSetG", "HB0" },
            { "S3", "K0", "N+GCP", "NStackSetG", "NStackSetG", "NStackSetG", "C13118", "R27756", "HS7", "HK2", "HP+_75_G_10_P_15", "HC0", "HR1_23_1050_13118_27756_124423_400000", "B0" },
            { "S3",       "+", "StackSet*", "StackSet*", "R999", "HR999_1001", "B0" },
            { "S6", "K4", "+-", "HS3", "H+-G", "R2_3_5_7_9_11_13_17_19_23_27_29_31_37", "HB0" },
            { "S3",       "Overflow", "+", "C1", "R10000", "StackSet*", "StackSetP", "StackSetC", "HR10000000", "HStackSetG", "B0" },
