...
public class LevelController {
    ...
    static String[][] levels_normal = {
            ...
            // 4
            { "S6", "K3", "R555_444", "HR222_444_666_888", "L+2*_+10*_-" },
            { "S6", "K3", "R1428", "HR1428_2857", "L+2*_+10*_-3*" },
            { "S6", "K3", "R3999", "HR1999_2998", "HB30", "P+10*_60_-_20_-3*_20", "StackSetG" },
            ...
            // Knight (Gemini 5)
            { "S4", "K3", "R400", "HR100_200_300_400", "HK0", "C-1", "G+", "StackSetG", "АCtrl + S!!!" },
